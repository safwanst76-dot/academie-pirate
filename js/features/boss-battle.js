...
(function () {
  ...
  var BOSS_IMGS = {
   // Grand Bleu — One Piece (images locales assets/images/avatars/)
    ...
    'Arlong':           'assets/images/avatars/clown.jpg',
    'Don Krieg':        'assets/images/avatars/whitebeard.png',  // reste .png
    'Mihawk':           'assets/images/avatars/mihawk.jpg',
    'Crocodile':        'assets/images/avatars/crocodile.jpg',
    'Perona':           'assets/images/avatars/hancock.jpg',
    'Absalom':          'assets/images/avatars/smoker.jpg',
    'Hogback':          'assets/images/avatars/hawkins.jpg',
    'Ryuma':            'assets/images/avatars/brook.jpg',
    // ── Français 6ème ──
    'Big Mom':          'assets/images/avatars/bigmom.jpg',
    'Barbe Noire':      'assets/images/avatars/blackbeard.jpg',
    'Doflamingo':       'assets/images/avatars/doflamingo.jpg',
    'Kaido':            'assets/images/avatars/kaido.jpg',
    'Burgess':          'assets/images/avatars/blackbeard.jpg',
    'Spandam':          'assets/images/avatars/rob-lucci.png',   // reste .png
    'Hody Jones':       'assets/images/avatars/clown.jpg',
    // ── Français 5ème ──
    'Kizaru':           'assets/images/avatars/smoker.jpg',
    'Akainu':           'assets/images/avatars/smoker.jpg',
    'Marine':           'assets/images/avatars/smoker.jpg',
    'CP9':              'assets/images/avatars/rob-lucci.png',   // reste .png
    'CP0':              'assets/images/avatars/kalifa.jpg',      // kalifa a espace dans le nom → smoker en fallback
    'Smoker':           'assets/images/avatars/smoker.jpg',
    // ── Français 4ème ──
    'Im':               'assets/images/avatars/crocodile.jpg',
    'Gorosei':          'assets/images/avatars/whitebeard.png',  // reste .png
    'Oz':               'assets/images/avatars/kaido.jpg',
    'Loki':             'assets/images/avatars/kaido.jpg',
    'Tous les Boss':    'assets/images/avatars/blackbeard.jpg',
    // ── Français 3ème — Brevet ──
    'Im Sama':                'assets/images/avatars/crocodile.jpg',
    'Les Cinq Doyens':        'assets/images/avatars/whitebeard.png',
    'Monkey D. Dragon':       'assets/images/avatars/blackbeard.jpg',
    'Dragon le Révolutionnaire': 'assets/images/avatars/blackbeard.jpg',
    'Garp le Héros':          'assets/images/avatars/whitebeard.png',
    'Garp':                   'assets/images/avatars/whitebeard.png',
    'Rayleigh':               'assets/images/avatars/mihawk.jpg',
    'Silvers Rayleigh':       'assets/images/avatars/mihawk.jpg',
    'Roger des Pirates':      'assets/images/avatars/shanks.jpg',
    'Roger le Roi':           'assets/images/avatars/shanks.jpg',
    'Gol D. Roger':           'assets/images/avatars/shanks.jpg',
    'Shiliew de la Pluie':    'assets/images/avatars/mihawk.jpg',
    'Charlotte Katakuri':     'assets/images/avatars/bigmom.jpg',
    'Katakuri':               'assets/images/avatars/bigmom.jpg',
    'Vinsmoke Judge':         'assets/images/avatars/sanji.jpg',
    'Aokiji':                 'assets/images/avatars/smoker.jpg',
    'Fujitora':               'assets/images/avatars/smoker.jpg',
    'Ryokugyu':               'assets/images/avatars/smoker.jpg',
    'Teach':                  'assets/images/avatars/blackbeard.jpg',
    'Marshall D. Teach':      'assets/images/avatars/blackbeard.jpg',
    'Newgate':                'assets/images/avatars/whitebeard.png',
    'BOSS FINAL Brevet':      'assets/images/avatars/blackbeard.jpg',
    // Magnolia — Dragon Ball Z (assets/images/dbz/ — local)
    'Freezer':    'assets/images/dbz/freezer.png',
    'Cell':       'assets/images/dbz/cell.jpg',
    'Broly':      'assets/images/dbz/broly.jpg',
    'Majin Buu':  'assets/images/dbz/majinbuu.png',
    'Beerus':     'assets/images/dbz/beerus.jpg',
    'Babidi':     'assets/images/dbz/babidi.jpg',
    'Raditz':     'assets/images/dbz/raditz.jpg',
    'Nappa':      'assets/images/dbz/nappa.png',
    'Ginyu':      'assets/images/dbz/ginyu.png',
    'Zarbon':     'assets/images/dbz/zarbon.png',
    ...
    // Pays du Feu — Naruto (bucket island-pays-du-feu, URLs propres sans espaces)
    'Sakura':          'https://bwxzrqsvccqmzvonsswi.supabase.co/storage/v1/object/public/island-pays-du-feu/characters/sakura.jpg',
    'Ino':             'https://bwxzrqsvccqmzvonsswi.supabase.co/storage/v1/object/public/island-pays-du-feu/characters/ino.jpg',
    'Itachi':          'https://bwxzrqsvccqmzvonsswi.supabase.co/storage/v1/object/public/island-pays-du-feu/characters/itachi.jpg',
    'Obito':           'https://bwxzrqsvccqmzvonsswi.supabase.co/storage/v1/object/public/island-pays-du-feu/characters/obito.jpg',
    'Neji':            'https://bwxzrqsvccqmzvonsswi.supabase.co/storage/v1/object/public/island-pays-du-feu/characters/neji.jpg',
    'Kiba':            'https://bwxzrqsvccqmzvonsswi.supabase.co/storage/v1/object/public/island-pays-du-feu/characters/kiba.jpg',
    ...
    'Pain':            'https://bwxzrqsvccqmzvonsswi.supabase.co/storage/v1/object/public/island-pays-du-feu/characters/pain.jpg',
    'Pain (Nagato)':   'https://bwxzrqsvccqmzvonsswi.supabase.co/storage/v1/object/public/island-pays-du-feu/characters/pain.jpg',
    'Tsunade':         'https://bwxzrqsvccqmzvonsswi.supabase.co/storage/v1/object/public/island-pays-du-feu/characters/tsunade.jpg',
    'Minato':          'https://bwxzrqsvccqmzvonsswi.supabase.co/storage/v1/object/public/island-pays-du-feu/characters/minato.jpg',
    'Jiraiya':         'https://bwxzrqsvccqmzvonsswi.supabase.co/storage/v1/object/public/island-pays-du-feu/characters/jiraiya.jpg',
    'Gaara':           'https://bwxzrqsvccqmzvonsswi.supabase.co/storage/v1/object/public/island-pays-du-feu/characters/gaara.jpg',
    'Shikamaru':       'https://bwxzrqsvccqmzvonsswi.supabase.co/storage/v1/object/public/island-pays-du-feu/characters/shikamaru.jpg',
    'Tenten':          'https://bwxzrqsvccqmzvonsswi.supabase.co/storage/v1/object/public/island-pays-du-feu/characters/tenten.jpg',
