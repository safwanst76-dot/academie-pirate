// ═══════════════════════════════════════════════════════════
// QUIZ-HISTOIRE.JS — Académie Pirate
// Matière : HISTOIRE — Programme 6ème / 5ème
// Thème visuel : Dragon Ball Z
// 8 îles × 11 questions (10 QCM + 1 Boss)
// Moteur de quiz indépendant (préfixe hist_)
...
const ISLANDS_HISTOIRE = {
  ...
  1:{name:"ÎLE DE GOKU",charName:"Goku",color:"#f97316",topic:"L'Égypte Ancienne",level:"6ème",
    ...
    qs:[
      ...
      {q:"Comment s'appelle le dieu soleil en Égypte ancienne ?",o:["Osiris","Anubis","Rê","Horus"],a:"Rê",exp:"Rê (ou Rà) est le dieu soleil principal. Le pharaon était considéré comme son fils."},
      ...
      {q:"⚔️ BOSS — Freezer envahit l'Égypte ! Réponds ou tout est perdu !<br><em>Quel animal sacré représentait le dieu Anubis ?</em>",o:["Le crocodile","Le chacal","Le chat","L'ibis"],a:"Le chacal",exp:"Anubis, dieu de l'embaumement, était représenté avec une tête de chacal. Il guidait les âmes.",isBoss:true,bossName:"Freezer",bossImg:""}
    ]
  },

  2:{name:"ÎLE DE VEGETA",charName:"Vegeta",color:"#3b82f6",topic:"La Grèce Antique",level:"6ème",
    ...
    qs:[
      {q:"Comment appelle-t-on les cités-États de la Grèce antique ?",o:["Les républiques","Les poleis","Les empires","Les dèmes"],a:"Les poleis",exp:"Les cités-États grecques s'appellent des poleis (singulier : polis). Chaque polis est une ville indépendante."},
      ...
      {q:"Comment s'appelle le récit d'Homère sur la guerre de Troie ?",o:["L'Odyssée","L'Énéide","L'Iliade","La Théogonie"],a:"L'Iliade",exp:"L'Iliade raconte la guerre de Troie. L'Odyssée raconte le retour d'Ulysse après cette guerre."},
      ...
      {q:"⚔️ BOSS — Cell s'empare d'Athènes ! Une seule réponse arrête Cell !<br><em>Qui a fondé la première démocratie athénienne au VIe s. av. J.-C. ?</em>",o:["Périclès","Clisthène","Socrate","Alexandre"],a:"Clisthène",exp:"Clisthène (508 av. J.-C.) est le père de la démocratie athénienne. Périclès l'a ensuite perfectionnée.",isBoss:true,bossName:"Cell",bossImg:""}
    ]
  },

  3:{name:"ÎLE DE PICCOLO",charName:"Piccolo",color:"#22c55e",topic:"Rome Antique",level:"6ème",
    ...
    qs:[
      ...
      {q:"⚔️ BOSS — Broly détruit Rome ! Seule la bonne réponse le stoppe !<br><em>En quelle année a eu lieu la chute de l'Empire romain d'Occident ?</em>",o:["395 apr. J.-C.","476 apr. J.-C.","1453 apr. J.-C.","753 av. J.-C."],a:"476 apr. J.-C.",exp:"476 apr. J.-C. marque la fin de l'Empire romain d'Occident. L'Empire d'Orient (Byzance) survit jusqu'en 1453.",isBoss:true,bossName:"Broly",bossImg:""}
    ]
  },

  4:{name:"ÎLE DE GOHAN",charName:"Gohan",color:"#a78bfa",topic:"Les Religions Monothéistes",level:"6ème",
    ...
    qs:[
      ...
      {q:"Qui est le prophète de l'islam ?",o:["Moïse","Abraham","Jésus","Mahomet"],a:"Mahomet",exp:"Mahomet (570-632 apr. J.-C.) est le prophète de l'islam. Il reçut le Coran à La Mecque et Médine."},
      ...
      {q:"Quelle ville est sainte pour l'islam, lieu de naissance de Mahomet ?",o:["Jérusalem","Médine","La Mecque","Bagdad"],a:"La Mecque",exp:"La Mecque (Arabie Saoudite) est la ville la plus sainte de l'islam. Les musulmans y font le pèlerinage."},
      ...
      {q:"Qu'est-ce que le monothéisme ?",o:["La croyance en plusieurs dieux","La croyance en un seul Dieu","Le refus de toute religion","La croyance en des esprits naturels"],a:"La croyance en un seul Dieu",exp:"Mono = un seul. Théisme = croyance en Dieu. Monothéisme = croyance en un seul Dieu unique."},
      ...
      {q:"⚔️ BOSS — Majin Buu menace les villes saintes ! Arrête-le !<br><em>Quel est le lieu de pèlerinage le plus important de l'islam ?</em>",o:["Jérusalem","Médine","La Mecque","Istanbul"],a:"La Mecque",exp:"La Mecque abrite la Grande Mosquée et la Kaaba, vers laquelle prient tous les musulmans du monde.",isBoss:true,bossName:"Majin Buu",bossImg:""}
    ]
  },

  5:{name:"ÎLE DE TRUNKS",charName:"Trunks",color:"#8b5cf6",topic:"Le Moyen-Âge",level:"5ème",
    ...
    qs:[
      ...
      {q:"Quelle est la bataille de 732 qui arrête l'expansion arabe en Europe ?",o:["La bataille d'Hastings","La bataille de Poitiers","La bataille de Bouvines","La bataille d'Azincourt"],a:"La bataille de Poitiers",exp:"Charles Martel arrête l'expansion des Arabes à Poitiers (732). Cette victoire préserve l'Europe occidentale."},
      {q:"Qu'est-ce qu'une cathédrale gothique ?",o:["Un château fort","Une grande église avec arcs-boutants et vitraux","Un palais royal","Un marché couvert"],a:"Une grande église avec arcs-boutants et vitraux",exp:"Les cathédrales gothiques (XIIe-XVe s.) se reconnaissent à leurs arcs-boutants et vitraux colorés. Ex : Notre-Dame de Paris."},
      ...
      {q:"⚔️ BOSS — Beerus, Dieu de la Destruction, attaque ! Réponds !<br><em>En quelle année Guillaume le Conquérant conquiert-il l'Angleterre ?</em>",o:["1066","1096","1215","1337"],a:"1066",exp:"Guillaume le Conquérant bat Harold à la bataille d'Hastings (1066) et devient roi d'Angleterre.",isBoss:true,bossName:"Beerus",bossImg:""}
    ]
  },

  6:{name:"ÎLE DE KRILIN",charName:"Krilin",color:"#f59e0b",topic:"L'Islam et son Expansion",level:"5ème",
    msgs:["Destructo-Disk de savoir !","Même sans cheveux, on peut être brilliant !","Android 18 me regarde... je dois réussir !","Continue, tu es fort !","La connaissance, c'est mon vrai pouvoir !"],
    qs:[
      {q:"En quelle année Mahomet fonde-t-il l'islam (Hégire) ?",o:["En 570 apr. J.-C.","En 622 apr. J.-C.","En 632 apr. J.-C.","En 750 apr. J.-C."],a:"En 622 apr. J.-C.",exp:"622 apr. J.-C. est l'année de l'Hégire : la fuite de Mahomet de La Mecque à Médine. Début du calendrier islamique."},
      ...
      {q:"Quelle ville espagnole est un symbole du rayonnement islamique en Europe ?",o:["Madrid","Barcelone","Cordoue","Séville"],a:"Cordoue",exp:"Cordoue (Al-Andalus) est au Xe s. la plus grande ville d'Europe. La Grande Mosquée de Cordoue est un chef-d'œuvre."},
      {q:"Combien de piliers compte l'islam ?",o:["3","4","5","6"],a:"5",exp:"Les 5 piliers : Shahada (profession de foi), Salat (prière), Zakat (aumône), Sawm (jeûne du Ramadan), Hajj (pèlerinage)."},
      ...
      {q:"⚔️ BOSS — Babidi menace Bagdad ! Réponds pour sauver l'Âge d'or !<br><em>Comment s'appelle le livre de voyage d'Ibn Battouta ?</em>",o:["Les Mille et une Nuits","La Rihla","Les Croisades","Al-Qanun"],a:"La Rihla",exp:"'La Rihla' (le Voyage) d'Ibn Battouta raconte ses 28 ans de voyage à travers l'Afrique, l'Asie et l'Europe.",isBoss:true,bossName:"Babidi",bossImg:""}
    ]
  },

  7:{name:"ÎLE DE BULMA",charName:"Bulma",color:"#06b6d4",topic:"Chrétienté et Croisades",level:"5ème",
    msgs:["Mon radar détecte les erreurs !","Je suis plus intelligente que toi ET papa !","Les Capsule Corp sponsorisent ta réussite !","Bien joué, presque aussi fort que Vegeta !","Allez, encore un effort !"],
    qs:[
      ...
      {q:"Qui était Richard Cœur de Lion ?",o:["Un roi de France","Un roi d'Angleterre chef de la 3e croisade","Un calife de Bagdad","Un pape"],a:"Un roi d'Angleterre chef de la 3e croisade",exp:"Richard Ier d'Angleterre mena la 3e croisade. Il s'opposa à Saladin sans reprendre Jérusalem."},
      ...
      {q:"⚔️ BOSS — Black Goku attaque Jérusalem ! Réponds !<br><em>En quelle année la première croisade prend-elle Jérusalem ?</em>",o:["1095","1099","1187","1291"],a:"1099",exp:"Jérusalem est prise par les croisés le 15 juillet 1099, 4 ans après le lancement de la 1ère croisade.",isBoss:true,bossName:"Black Goku",bossImg:""}
    ]
  },

  8:{name:"ÎLE DE YAMCHA",charName:"Yamcha",color:"#e63946",topic:"Renaissance & Grandes Découvertes",level:"5ème",
    msgs:["Fūga Zanmaiken ! Réponds vite !","Je ne suis pas si faible en histoire !","Bulma était impressionnée par mes réponses !","Continue, tu bats Végéta en histoire !","Le loup du désert sait son cours !"],
    qs:[
      ...
      {q:"Qu'est-ce que l'humanisme à la Renaissance ?",o:["Une religion nouvelle","Un courant de pensée qui place l'être humain au centre","Un mouvement artistique uniquement","Un système politique"],a:"Un courant de pensée qui place l'être humain au centre",exp:"Les humanistes (Érasme, Rabelais) placent l'homme au centre et encouragent l'éducation et la raison."},
      ...
      {q:"⚔️ BOSS — Zamasu veut effacer les Grandes Découvertes ! Arrête-le !<br><em>Quelle œuvre de Léonard de Vinci est la plus célèbre au monde ?</em>",o:["La Vénus de Milo","La Joconde","Le David","La Naissance de Vénus"],a:"La Joconde",exp:"La Joconde (1503-1519) est le portrait le plus célèbre du monde. Elle est exposée au Musée du Louvre à Paris.",isBoss:true,bossName:"Zamasu",bossImg:""}
    ]
  }
};

// ══════════════════════════════════════════════════════════════
// ÉTAT GLOBAL HISTOIRE
// ══════════════════════════════════════════════════════════════
var hist_xp = 0, hist_completedIslands = {}, hist_currentIsland = 0;
var hist_streak = 0, hist_answers = {};

// ── Cinématique intro par île ──
const HIST_ISLE_INTRO = {
  1:{bg:'#1a0800',lines:['ÉGYPTE…','… ANCIENNE !!','Le Nil coule dans tes veines !'],kanji:'古代 !!',kanjiColor:'#f97316',bubble:"Kaio-Ken × 3 ! On va tout savoir sur l'Égypte !",particles:'sparks'},
  2:{bg:'#00051a',lines:['GRÈCE…','… ANTIQUE !!','La démocratie t\'appelle !'],kanji:'民主 !!',kanjiColor:'#3b82f6',bubble:"Je suis le Prince ! Et les Grecs sont mes ancêtres de savoir.",particles:'ice'},
  3:{bg:'#001a05',lines:['ROME…','… ÉTERNELLE !!','César te regarde !'],kanji:'永遠 !!',kanjiColor:'#22c55e',bubble:"Makanko Sappo ! On démarre Rome avec puissance.",particles:'sparks'},
  4:{bg:'#0d0020',lines:['RELIGIONS…','… MONOTHÉISTES !!','Trois révélations, un seul Dieu !'],kanji:'信仰 !!',kanjiColor:'#a78bfa',bubble:"Super Saiyan 2 ! La foi et la connaissance sont ma force !",particles:'sparks'},
  5:{bg:'#050014',lines:['MOYEN-ÂGE…','… MÉDIÉVAL !!','Les châteaux te défient !'],kanji:'中世 !!',kanjiColor:'#8b5cf6',bubble:"Je viens du futur — les chevaliers n'ont aucun secret pour moi !",particles:'ice'},
  6:{bg:'#1a1000',lines:['ISLAM…','… ÂGE D\'OR !!','Bagdad t\'accueille !'],kanji:'知識 !!',kanjiColor:'#f59e0b',bubble:"Destructo-Disk ! On va tout écraser sur l'Islam !",particles:'sparks'},
  7:{bg:'#00101a',lines:['CROISADES…','… ET CHRÉTIENTÉ !!','Jérusalem t\'attend !'],kanji:'十字 !!',kanjiColor:'#06b6d4',bubble:"Mon radar détecte toutes les erreurs historiques !",particles:'sparks'},
  8:{bg:'#1a0000',lines:['RENAISSANCE…','… GRANDES DÉCOUVERTES !!','Colomb a besoin de toi !'],kanji:'発見 !!',kanjiColor:'#e63946',bubble:"Le Loup du Désert est là ! On explore le XVe siècle !",particles:'fire'}
};
...
function hist_startIsland(n) {
  if (typeof playBGM === 'function') playBGM('isle-' + n);
...
function hist_launchIsland(n) {
  hist_currentIsland = n; hist_answers = {};
  ...
  isle.qs.forEach(function(e, i) {
    ...
    const opts = e.o.map(function(opt,j){
      return `<label class="hist-opt" id="hist-lbl${i}_${j}" onclick="hist_selectOpt(${i},${j},${JSON.stringify(opt)})">
        <span class="hist-opt-key">${keys[j]}</span><span class="hist-opt-txt">${opt}</span></label>`;
    }).join('');
    html += `<div class="hist-q-card${e.isBoss?' hist-boss-q':''}" id="hist-card${i}" style="--isle-color:${isle.color}">
      ${bossBanner}
      <div class="hist-char-bubble">
        <img src="${avatar}" alt="${isle.charName}" class="hist-char-img" onerror="this.style.display='none'">
...
function hist_corriger(n) {
  const isle = ISLANDS_HISTOIRE[n]; if(!isle) return;
  let score=0; hist_streak=0;
  isle.qs.forEach(function(e,i){
    const ans=hist_answers[i], fb=document.getElementById('hist-fb'+i), expl=document.getElementById('hist-exp'+i);
    e.o.forEach(function(_,j){ var b=document.getElementById('hist-lbl'+i+'_'+j); if(b) b.style.pointerEvents='none'; });
    if(!ans){
      ...
      if(ok){
        ...
        var btn=document.getElementById('hist-lbl'+i+'_'+ans.oi); if(btn) btn.classList.add('hist-correct');
        if(typeof sfxOK==='function') sfxOK();
        if(typeof showCombatGif==='function') showCombatGif(score===10?'perfect':'correct');
        else hist_showGif(score===10?'perfect':'correct');
        ...
        hist_streak=0;
        if(fb){fb.innerHTML='❌ Raté ! Réponse : <strong>'+e.a+'</strong>'; fb.className='hist-fb hist-ko';}
        var wb=document.getElementById('hist-lbl'+i+'_'+ans.oi); if(wb) wb.classList.add('hist-wrong');
        e.o.forEach(function(opt,j){ if(opt===e.a){var b=document.getElementById('hist-lbl'+i+'_'+j);if(b) b.classList.add('hist-correct');}});
        if(typeof sfxKO==='function') sfxKO();
        if(typeof showCombatGif==='function') showCombatGif('wrong');
        else hist_showGif('wrong');
      }
    }
    if(expl){expl.innerHTML='💡 '+e.exp; expl.className='hist-expl hist-show';}
  });
  hist_xp += score*2; hist_completedIslands[n]=score;
...
// ══════════════════════════════════════════════════════════════
// GIF / RÉSULTATS / NAVIGATION
// ══════════════════════════════════════════════════════════════
function hist_showGif(type){
  var list=type==='perfect'?HIST_GIFS_PERFECT:type==='correct'?HIST_GIFS_CORRECT:HIST_GIFS_WRONG;
  var src=list[Math.floor(Math.random()*list.length)];
  var ov=document.getElementById('combat-gif-overlay'); if(!ov) return;
  var img=ov.querySelector('img'); if(img) img.src=src;
  ov.style.display='flex'; clearTimeout(ov._t);
  ov._t=setTimeout(function(){ov.style.display='none';},2000);
}

function hist_showResults(n,score){
  const isle=ISLANDS_HISTOIRE[n], gained=score*2;
  const txts=[{min:10,t:'ULTRA INSTINCT ! 10/10 !'},{min:8,t:'EXCELLENT ! Saiyan d\'élite !'},{min:6,t:'Bien joué, apprenti guerrier !'},{min:4,t:'Continue l\'entraînement !'},{min:0,t:'Ne lâche pas ! Kaio-Ken !'}];
  const res=txts.find(function(r){return score>=r.min;})||txts[txts.length-1];
  const gif=score===10?HIST_GIFS_PERFECT[0]:score>=6?HIST_GIFS_WIN[n%HIST_GIFS_WIN.length]:HIST_GIFS_LOSE[0];
  const stars=Array.from({length:10},function(_,i){return i<score?'⭐':'☆';}).join('');
  const html=`<div class="hist-result-card" id="hist-resCard">
    <div class="hist-result-banner" style="background:${isle.color}22">
  ...
  var c=document.getElementById('hist-qContainer'); if(c) c.innerHTML+=html;
  setTimeout(function(){var rc=document.getElementById('hist-resCard');if(rc) rc.scrollIntoView({behavior:'smooth',block:'center'});},400);
}

function hist_goBack(){
  if(typeof playBGM==='function') playBGM('map');
  document.getElementById('histoire-quiz-sec').style.display='none';
  document.getElementById('histoire-iles-sec').style.display='block';
  hist_answers={}; window.scrollTo(0,0);
}

function hist_retry(n){ hist_answers={}; hist_startIsland(n); }

// ══════════════════════════════════════════════════════════════
// CINÉMATIQUE DBZ LÉGÈRE
// ══════════════════════════════════════════════════════════════
function hist_playCinematic(n,callback){
  const cfg=HIST_ISLE_INTRO[n]; if(!cfg){if(callback) callback(); return;}
  let ov=document.getElementById('hist-cine-overlay');
  if(!ov){ov=document.createElement('div');ov.id='hist-cine-overlay';document.body.appendChild(ov);}
  ov.innerHTML=`<div class="hist-cine-inner" style="background:${cfg.bg}">
    <div class="hist-cine-kanji" style="color:${cfg.kanjiColor}">${cfg.kanji}</div>
    <div class="hist-cine-lines">${cfg.lines.map(function(l){return '<div class="hist-cine-line">'+l+'</div>';}).join('')}</div>
    <div class="hist-cine-bubble">"${cfg.bubble}"</div>
    <button class="hist-skip-btn" onclick="hist_skipCine()">⏭ PASSER</button>
  </div>`;
  ov.style.cssText='position:fixed;inset:0;z-index:9500;display:flex;align-items:center;justify-content:center;opacity:0;transition:opacity 0.4s';
  ov._cb=callback;
...
function buildHistoireGrid() {
  ...
  for (var n = 1; n <= 8; n++) {
    ...
    html += '<div class="hist-isle-card' + (done?' done':'') + '" onclick="hist_startIsland('+n+')" style="--isle-color:'+isle.color+'">' +
      '<img src="'+avatar+'" alt="'+isle.charName+'" class="hist-isle-img" onerror="this.style.display=\'none\';this.nextElementSibling.style.display=\'flex\'">' +
      '<div class="hist-isle-img-fallback" style="display:none">'+HIST_FALLBACK[n]+'</div>' +
...
console.info('🐉 quiz-histoire.js chargé — 8 îles × 11 questions DBZ OK');
