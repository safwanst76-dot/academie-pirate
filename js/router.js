...
var SEO_ROUTES = {
  ...
  'histoire/cm2':  { title: 'Quiz Histoire CM2 — France · Académie Pirate',           desc: '8 îles Histoire CM2 : Préhistoire, Antiquité gauloise, Moyen Âge, Renaissance, Lumières, Révolution, Empire, République.' },
  'histoire/6eme': { title: 'Quiz Histoire 6ème — Antiquité · Académie Pirate',        desc: '8 îles Histoire 6ème : Préhistoire, Égypte ancienne, Grèce antique, Rome, naissance du christianisme, Mésopotamie, mythologies, cités.' },
  'histoire/5eme': { title: 'Quiz Histoire 5ème — Moyen Âge · Académie Pirate',        desc: '8 îles Histoire 5ème : Byzance, Islam médiéval, Carolingiens, croisades, peste noire, Renaissance, grandes découvertes, Réformes.' },
  'histoire/4eme': { title: 'Quiz Histoire 4ème — XIXe siècle · Académie Pirate',     desc: '8 îles Histoire 4ème : Lumières, Révolution française, Napoléon, industrialisation, nationalismes, IIe Empire, colonisation, IIIe République.' },
  'histoire/3eme': { title: 'Quiz Histoire 3ème — Brevet · Académie Pirate',           desc: '8 îles Histoire 3ème Brevet : 1ère GM, totalitarismes, 2nde GM, Shoah, Guerre froide, décolonisations, Ve République, monde actuel.' },
  ...
  'pays-du-feu/cm2':  { title: 'Quiz Maths CM2 — Naruto · Académie Pirate',          desc: '8 îles Maths CM2 : numération, fractions simples, division, géométrie, périmètre/aire, mesures, proportionnalité, résolution de problèmes.' },
  'pays-du-feu/6eme': { title: 'Quiz Maths 6ème — Décimaux · Académie Pirate',       desc: '8 îles Maths 6ème : nombres décimaux, proportionnalité, fractions, géométrie plane, symétrie, périmètre, aire, gestion de données.' },
  'pays-du-feu/5eme': { title: 'Quiz Maths 5ème — Calcul · Académie Pirate',         desc: '8 îles Maths 5ème : fractions, nombres relatifs, équations simples, triangles, parallélogrammes, prismes, statistiques, probabilités.' },
  'pays-du-feu/4eme': { title: 'Quiz Maths 4ème — Pythagore · Académie Pirate',      desc: '8 îles Maths 4ème : puissances, calcul littéral, équations, Pythagore, fonctions linéaires, triangles rectangles, probabilités, statistiques.' },
  'pays-du-feu/3eme': { title: 'Quiz Maths 3ème — Brevet · Académie Pirate',         desc: '8 îles Maths 3ème Brevet : Thalès, trigonométrie, racines carrées, calcul littéral avancé, équations, fonctions affines, statistiques.' },
  ...
  'grand-bleu/3eme': { title: 'Quiz Français 3ème — Brevet · Académie Pirate',     desc: '8 îles Français 3ème Brevet : analyse littéraire, modes verbaux, syntaxe complexe, figures de style, dissertation, oral.' },
...
window.showContinentPanel = function (c) {
  ...
  if (route === 'carte') {
   ...
   const targetRoute = c.id === 'history' ? 'histoire' : c.id === 'kanto' ? 'kanto' : c.id === 'math' ? 'pays-du-feu' : c.id === 'geography' ? 'namek' : c.id === 'english' ? 'english' : c.id === 'brevet' ? 'brevet' : 'iles';
    panel.innerHTML = `
      <div class="gp-header">
